        ...
        <div class="grid grid-cols-4 gap-6 p-10">
            ...
            <section class="col-span-3">
                ...
                <div class="min-h-[87%] flex flex-col bg-cGray2 rounded-2xl shadow-bsBox pt-5 px-12">
                    ...
                    {{-- Participant --}}
                    <form class="flex flex-col mt-8" action="/admin/hack/participant/update/{{$user->user->id}}" method="post">
                        @csrf
                        {{-- Full Name --}}
                        <div class="w-full flex flex-col bg-cGray2 mb-4">
                            ...
                            <div class="w-full flex flex-row bg-cGrayInput rounded-2xl py-4">
                                ...
                                <input class="w-full sans text-cText bg-cGrayInput border-none focus:ring-0
                                placeholder:text-cPlaceholder" type="text" value="{{$user->user->name}}" name="name"
                        ...
                        <div class="w-full flex flex-col bg-cGray2 mb-4">
                            ...
                            <div class="w-full flex flex-row bg-cGrayInput rounded-2xl py-4">
                                ...
                                <input class="w-full sans text-cText bg-cGrayInput border-none focus:ring-0
                                placeholder:text-cPlaceholder" type="text" value="{{$user->user->place_of_birth}}" name="place_of_birth"
                        ...
                        <div class="w-full flex flex-col bg-cGray2 mb-4">
                            ...
                            <div class="w-full flex flex-row bg-cGrayInput rounded-2xl py-4">
                                ...
                                <input class="w-full sans text-cText bg-cGrayInput border-none focus:ring-0
                                placeholder:text-cPlaceholder" type="date" value="{{$user->user->date_of_birth}}" name="date_of_birth">
                            </div>
                        </div>
                        {{-- Gender --}}
                        <div class="w-full flex flex-col bg-cGray2 mb-4">
                            ...
                            <div class="w-full flex flex-row bg-cGrayInput rounded-2xl py-4">
                                ...
                                <input class="w-full sans text-cText bg-cGrayInput border-none focus:ring-0
                                placeholder:text-cPlaceholder" type="text" value="{{$user->user->gender}}" name="gender"
                        ...
                        <div class="w-full flex flex-col bg-cGray2 mb-4">
                            ...
                            <div class="w-full flex flex-row bg-cGrayInput rounded-2xl py-4">
                                ...
                                <input class="w-full sans text-cText bg-cGrayInput border-none focus:ring-0
                                placeholder:text-cPlaceholder" type="email" value="{{$user->user->email}}" name="email"
                        ...
                        <div class="w-full flex flex-col bg-cGray2 mb-4">
                            ...
                            <div class="w-full flex flex-row bg-cGrayInput rounded-2xl py-4">
                                ...
                                <input class="w-full sans text-cText bg-cGrayInput border-none focus:ring-0
                                placeholder:text-cPlaceholder" type="text" value="{{$user->user->line_id}}" name="line_id"
                                placeholder="LINE ID">
                            </div>
                        </div>
                        {{-- Whatsapp Number --}}
                        <div class="w-full flex flex-col bg-cGray2 mb-4">
                            ...
                            <div class="w-full flex flex-row bg-cGrayInput rounded-2xl py-4">
                                ...
                                <input class="w-full sans text-cText bg-cGrayInput border-none focus:ring-0
                                placeholder:text-cPlaceholder" type="text" value="{{$user->user->whatsapp}}" name="whatsapp"
                        ...
                        <div class="w-full flex flex-col bg-cGray2 mb-4">
                            ...
                            <div class="w-full flex flex-row bg-cGrayInput rounded-2xl py-4">
                                ...
                                <input class="w-full sans text-cText bg-cGrayInput border-none focus:ring-0
                                placeholder:text-cPlaceholder" type="text" value="{{$user->user->company}}" name="company"
                        ...
                        <div class="my-8 mb-12 flex flex-row justify-between">
                            ...
                            <button class="font-PJSSemiBold text-cGray2 tracking-wider rounded-2xl
                            bg-cLinearGradientBlueDecoration drop-shadow-dsBlueDecor
                            px-10 py-3">
                                    Save Changes
                            </button>
                        </div>
