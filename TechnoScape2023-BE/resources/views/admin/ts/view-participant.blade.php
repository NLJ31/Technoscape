            ...
            <div class="min-h-[87%] flex flex-col bg-cWhiteS rounded-2xl shadow-bsBox pt-5 px-12">
                ...
                <div class="flex flex-col mt-8">
                    ...
                    <div class="my-8 flex flex-row justify-between">
                        ...
                        <div class="flex flex-row">
                            <a href="/admin/ts/participant/edit/{{$user->id}}" class="font-PJSSemiBold rounded-2xl border border-cBlue
                                bg-cLinearGradientBlue
                                text-transparent bg-clip-text
                                shadow-bsBox px-8 py-3 mr-6">
                                    Edit
                            </a>
                            <button onclick="openModal({{$user->id}}, 'ts')" class="font-PJSSemiBold rounded-2xl border border-cBlue
                                bg-cLinearGradientBlue
                                text-transparent bg-clip-text
                                shadow-bsBox px-8 py-3">
                                    Remove
