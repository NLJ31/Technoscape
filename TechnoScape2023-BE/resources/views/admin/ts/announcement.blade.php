...
<body class="bg-cWhite relative overflow-x-hidden">
    ...
    <div id="modal" class="hidden w-screen h-full bg-[#67676780] flex flex-col items-center justify-center z-10 absolute  overflow-hidden">
        <div class="flex flex-col items-center bg-cWhite rounded-3xl p-4 px-6 pb-12">
            ...
            <form class="flex flex-col" action="{{route('storeTsAnnouncement')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                bg-cGray rounded-2xl border-none ffocus:ring-0 focus:border-0 focus:outline-none
                ...
                <div class="flex flex-row justify-between">
                    ...
                    <label for="file" class="flex flex-row text-base font-PJSSemiBold rounded-2xl border  border-cBlack2
                    ...
                    rounded-2xl px-9 py-2" type="submit">
                        Submit
                    </button>
                </div>
            </form>
    ...
    <div id="deleteModal" class="hidden w-screen h-full bg-[#67676780] flex flex-col items-center justify-center z-10 absolute  overflow-hidden">
        <div class="flex flex-col items-center bg-cWhite rounded-xl p-4 pb-12">
            ...
            <div class="flex flex-col items-center justify-center">
                ...
                <div id="change" class="font-PJSExtraBold text-cBlack text-2xl tracking-wide mx-16 mb-2">Remove this announcement?</div>
    ...
    <div class="grid grid-cols-4 gap-6 p-10">
        ...
        <section class="col-span-3">
            ...
            <div class="flex flex-row items-center bg-cWhite rounded-2xl shadow-bsBox pt-5 px-12 mb-6">
                ...
                <a href="{{url('/admin/ts/participant')}}"
                    ...
                    <div class="box w-full bg-cLinearGradientBlue rounded-2xl py-6 pb-4 px-8 mb-4">
                        ...
                        <div class="content hidden w-full bg-[#FAFAFF1A] rounded-xl py-4 px-4 mb-4">
                            ...
                            <div class="flex flex-row justify-between">
                                ...
                                <a href="{{ url('storage/announcement/ts/'.$announcement->file) }}" target="blank_" class="flex flex-row items-center bg-cWhite text-cBlue rounded-lg
                                ...
                                @endif
                                <button onclick="openAnnouncementDeleteModal({{$announcement->id}}, 'ts')" class="flex flex-row items-center bg-cWhite text-cBlue rounded-lg
