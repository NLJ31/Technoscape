...
@section('body')
    <body class="bg-cWhite relative overflow-x-hidden">
        ...
        <div class="grid grid-cols-4 gap-6 p-10 z-0">
            {{-- Side Bar --}}
            ...
            <section class="col-span-3">
                ...
                <div class="flex flex-row items-center bg-cWhite rounded-2xl shadow-bsBox pt-5 px-12 mb-6">
                    <a href="{{url('/admin/ts/announcement')}}"
                ...
                <div class="min-h-[87%] flex flex-col bg-cWhite rounded-2xl shadow-bsBox pt-5 px-12">
                    ...
                    <form class="flex flex-row justify-between">
                        ...
                        rounded-xl font-PJSMedium bg-clip-text text-transparent bg-cLinearGradientBtn py-2 px-6">Jangan Di Klik, Ntar Nyesel!</a>
                    ...
                    <div class="flex flex-col mt-8 mb-10">
                        ...
                        <div class="w-full flex flex-row justify-between items-center bg-cWhite shadow-bsBox rounded-2xl pr-8 mb-4">
                            ...
                            <div class="w-fit flex flex-row items-center">
                                <a href="{{route('viewTsParticipantPage', $user->id)}}" class="font-PJSSemiBold text-cText hover:text-cBlue mr-12">
                                    View
                                </a>
                                <a href="{{route('editTsParticipantPage', $user->id)}}" class="font-PJSSemiBold text-cText hover:text-cBlue mr-12">
                                    Edit
                                </a>
                                <button onclick="openModal({{$user->id}}, 'ts')" class="font-PJSSemiBold text-cText hover:text-cBlue">
                                    Remove
                                </button>
                            </div>
                        </div>
