            ...
            <section class="col-span-3">
                ...
                <div class="min-h-[87%] flex flex-col bg-cWhite rounded-2xl shadow-bsBox pt-5 px-12">
                    ...
                    <form class="flex flex-row self-end">
                        ...
                        rounded-xl font-PJSMedium bg-clip-text text-transparent bg-cBtnGradientaS py-2 px-6">Export Participant</a>
                        --}}
                    ...
                    <div class="flex flex-row item-center">
                        ...
                        <a href="{{url('admin/ta/payment/paid ')}}">
                            <button class="font-PJSSemiBold text-cWhite
                            tracking-wider rounded-2xl bg-cLinearGradientBlue drop-shadow-dsBlueDecor
                            px-8 py-2 mr-4">Unverified</button>
                        </a>
                        <a href="{{url('admin/ta/payment/accepted')}}">
                            <button class="font-PJSSemiBold text-cWhite
                            tracking-wider rounded-2xl bg-cLinearGradientBlue drop-shadow-dsBlueDecor
                            px-8 py-2 mr-4">Verified</button>
                        </a>
                        <a href="{{url('admin/ta/payment/rejected')}}">
                            <button class="font-PJSSemiBold text-cWhite
                            tracking-wider rounded-2xl bg-cLinearGradientBlue drop-shadow-dsBlueDecor
                    ...
                    <div class="flex flex-col mt-8 mb-10">
                        ...
                        <div class="w-full flex flex-row justify-between items-center bg-cWhite shadow-bsBox rounded-2xl pr-8 mb-4">
                            ...
                            <div class="w-fit flex flex-row">
                                ...
                                <a href="{{asset('/storage/ta-registrationProof/'.$user->payment_receipt)}}" onclick="openPaymentModal('{{asset('/storage/ta-registrationProof/'.$user->payment_receipt)}}', {{$user->user->id}}, 'ta')" download class="cursor-pointer">
                                    <img src="{{asset('assets/admin/arrow.svg')}}" alt="">
                                </a>
                                @else
                                <div class="cursor-pointer">
                                    <img onclick="openPaymentModal('{{asset('/storage/ta-registrationProof/'.$user->payment_receipt)}}', {{$user->user->id}}, 'ta')" src="{{asset('assets/admin/arrow.svg')}}" alt="">
                                </div>
                                @endif
                            </div>
                        </div>
