            ...
            <section class="col-span-3">
                ...
                <div class="min-h-[87%] flex flex-col bg-cWhite rounded-2xl shadow-bsBox pt-5 px-12">
                    ...
                    <form class="flex flex-row justify-between">
                        <a href="/admin/ta/participant/export" target="_blank"
                        class="w-max flex flex-row justify-end self-end text-sm border-cBlack border
                        rounded-xl font-PJSMedium bg-clip-text text-transparent bg-cLinearGradientBlue py-2 px-6">Top Up OVO 50rb</a>
                    ...
                    <div class="flex flex-col mt-8 mb-10">
                        ...
                        <div class="w-full flex flex-row justify-between items-center bg-cWhite shadow-bsBox rounded-2xl pr-8 mb-4">
                            ...
                            <div class="w-fit flex flex-row items-center">
                                <a href="{{route('viewTaParticipantPage', $user->user->id)}}" class="font-PJSSemiBold text-cText hover:text-cBlue mr-12">
                                    View
                                </a>
                                <a href="{{route('editTaParticipantPage', $user->user->id)}}" class="font-PJSSemiBold text-cText hover:text-cBlue mr-12">
                                    Edit
                                </a>
                                <button onclick="openModal({{$user->user->id}}, 'ta')" class="font-PJSSemiBold text-cText hover:text-cBlue">
                                    Remove
                                </button>
                            </div>
                        </div>
