    ...
    <body class="bg-cWhite relative overflow-x-hidden">
        ...
        <div id="modal" class="hidden w-screen h-full bg-[#67676780] flex flex-col items-center justify-center z-10 absolute  overflow-hidden">
            <div class="flex flex-col items-center bg-cWhite rounded-3xl p-4 px-6 pb-12">
                ...
                <form class="flex flex-col" action="{{route('storeTaAnnouncement')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <input id="event_type" type="hidden" name="event_type" value="ta">
                        ...
                        <div class="box w-full bg-cLinearGradientBlue rounded-2xl py-6 pb-4 px-8 mb-4">
                            ...
                            <div class="content hidden w-full bg-[#FAFAFF1A] rounded-xl py-4 px-4 mb-4">
                                ...
                                <div class="flex flex-row justify-between">
                                    ...
                                    <a href="{{ url('storage/announcement/ta/'.$announcement->file) }}" target="blank_" class="flex flex-row items-center bg-cWhite text-cBlue rounded-lg
                                    ...
                                    @endif
                                    <button onclick="openAnnouncementDeleteModal({{$announcement->id}}, 'ta')" class="flex flex-row items-center bg-cWhite text-cBlue rounded-lg
